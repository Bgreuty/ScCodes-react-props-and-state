              ...
              <div className="card-block">
                ...
                <form onSubmit={this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea value={this.state.comment} onChange={this.handleCommentChange} className="form-control" name="comment" rows="3" type="text" />
                  </div>
                  <div className="form-group">
                    <input value={this.state.author} onChange={this.handleAuthorChange} className="form-control col-md-3" name="author" type="text"/>
                  </div>
